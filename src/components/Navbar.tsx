...
const Navbar = () => {
    ...
    return (
        <div 
            className='fixed top-0 bottom-5 h-220 flex flex-col text-white items-center justify-start p-4 m-5 mb-5 rounded-[15px] gap-15
                        pointer-events-auto' 
            style={{ backgroundColor: '#0B083E' }}
        >
            <div className=" text-2xl font-bold mb-4"><Link href="">Logo</Link></div>

            <Link href="/" className="flex flex-col items-center gap-1" onClick={()=>handleclick(1)}>
            ...
            <Link href="/" className="flex flex-col items-center gap-1 p-2 duration-300 " onClick={()=>handleclick(2)}>
            ...
            <Link href="/" className="flex flex-col items-center gap-1" onClick={()=>handleclick(3)}>
            ...
            <Link href="/" className="flex flex-col items-center gap-1" onClick={()=>handleclick(4)}>
